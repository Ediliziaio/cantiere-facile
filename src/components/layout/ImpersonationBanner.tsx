  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[9999] h-10 bg-primary flex items-center justify-between px-4">
      <div className="flex items-center gap-2 text-primary-foreground text-sm font-medium">
        ...
        <span>Modalità visualizzazione: stai navigando come <strong>{impersonation.tenantName}</strong> · ruolo: <strong className="capitalize">{impersonation.impersonatedRole}</strong></span>
      </div>
      <Button
        variant="ghost"
        size="sm"
